    ...
    <div className="w-full h-full flex flex-col lg:flex-row gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex-1 flex flex-col space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="glass-panel px-4 py-1.5 rounded-full text-sm font-medium text-gray-300">
            {data.frames_processed} Frames Analyzed
          </div>
        </div>

        <div className="glass-panel rounded-2xl overflow-hidden aspect-video border border-white/10 shadow-2xl relative">
